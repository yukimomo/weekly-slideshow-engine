"""Smoke test for mixed photo+video concatenation rendering."""
...
def test_render_mixed_photo_video(tmp_path: Path) -> None:
    # Create two photos and one tiny video
    p1 = tmp_path / "a.png"
    p2 = tmp_path / "b.png"
    v = tmp_path / "t.mp4"
